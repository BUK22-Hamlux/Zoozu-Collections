...
const PROCESS_STEPS = [
  {
    ...
    body: "You receive an email confirmation immediately after placing your order.",
  },
  {
    step: "02",
    title: "Processing",
    body: "We verify your payment and prepare your items. This takes 1 – 24 hours.",
  },
  {
    step: "03",
    title: "Dispatched",
    body: "Your order is handed to the courier. You'll receive a tracking number by SMS.",
  },
  {
    step: "04",
    title: "Delivered",
    body: "Your package arrives at your door. Please inspect it before signing.",
  },
];
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-text/60 max-w-md mx-auto">
          We deliver across Nigeria. Here's everything you need to know about
          our shipping options and timelines.
        </p>
      </div>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {SHIPPING_OPTIONS.map(
            ({ name, duration, cost, note, icon: Icon, highlight }) => (
              <div
                key={name}
              ...
              >
                ...
                <div
                  className={`w-10 h-10 rounded-lg flex items-center justify-center mb-4 ${highlight ? "bg-primary/20 text-primary" : "bg-text/10 text-text"}`}
                >
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          {PROCESS_STEPS.map(({ step, title, body }) => (
            <div
              key={step}
              className="flex items-start gap-5 bg-section border border-text/10 rounded-xl p-5"
            >
      ...
      <div className="flex items-start gap-3 bg-yellow-50 border border-yellow-200 rounded-xl p-5">
        ...
        <p className="text-yellow-800 text-sm">
          <strong>Public holidays and weekends</strong> are not counted as
          business days. Orders placed on Friday after 3pm will begin processing
